...
<div class="col-sm-5 mb-4">
    ...
    <div class="card text-center" 
                ...
                <br>
                        ...
                        border : 8px solid #5B9BD5; border-radius: 30px;width: 750px; height : 650px;">
                    ...
                    <tr>
                      <td><br></td>
                          ...
                          <tr>
                            ...
                            <td align="center" style="width:50px;">:</td>
                            <td align="left"><input type="text" style="width: 400px;  height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="supplier" required></td>
                          </tr>
                              <tr>
                            <td align="left" style="padding-left: 50px;width:220px; font-family : times new roman ; font-size : 25px ;"><h>Nama Barang</h></td>
                            <td align="center" style="width:50px;">:</td>

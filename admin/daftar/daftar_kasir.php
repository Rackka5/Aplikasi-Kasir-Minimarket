...
<div class="col-sm-5 mb-4">
    ...
    <div class="card text-center" 
                ...
                <br>
								<form action="../proses/proses_kasir.php?aksi=tambah" method="POST">
                        ...
                        border : 8px solid #5B9BD5; border-radius: 30px;width: 650px; height : 450px;">
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td align="left"><input type="text" style="width: 400px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="username" required></td>
                            </tr>
                          <tr>
                            <td style="font-family : times new roman ; font-size : 25px ;">Password</td>
                            <td>:</td>
                            <td align="left"><input type="password" style="width: 400px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="password" required></td>
                          </tr> 
                          <tr>

...
$db = new database;
$data = $db->tampil_brng($_GET['id_barang']);
?>                 
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="col-sm-5 mb-4">
    ...
    <div class="card text-center" 
                ...
                foreach($data as $d){
                ?>
								<form action="../proses/proses_barang.php?aksi=stok" method="POST">
                                    <table align="center" style="background-color : #AAD7D9 ;
                        border : 8px solid #5B9BD5; border-radius: 30px;width: 750px; height : 550px;">
                              <input type="hidden" name="id_barang" value="<?Php echo $d['id_barang'] ?>">    
                              <tr>
                                <td><br></td>
                              </tr>
                              <tr>
                            <td align="left" style="padding-left: 50px;width:220px; font-family : times new roman ; font-size : 25px ;"><h>Supplier</h></td>
                            <td align="center" style="width:50px;">:</td>
                            <td align="left"><input type="text" style="width: 400px;  height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" 
                            name="supplier" required></td>
                          </tr>  
                              <tr>
                            <td align="left" style="padding-left: 50px;width:220px; font-family : times new roman ; font-size : 25px ;"><h sty>Nama Barang</h></td>
                            <td align="center" style="width:50px;">:</td>
                            <td align="left"><input type="text" style="width: 400px;  height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="nama_barang" 
                            value="<?php echo $d['nama_barang'] ?>" readonly="readonly"></td>
                          </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;font-family : times new roman ; font-size : 25px ;"><h>Kode Barang</h></td>
                            <td>:</td>
                            <td align="left"><input type="text" style="width: 400px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="kode_barang" 
                            value="<?php echo $d['kode_barang'] ?>" readonly="readonly"></td>
                            </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;font-family : times new roman ; font-size : 25px ;">Tanggal Masuk</td>
                            <td>:</td>
                            <td align="left"><input type="text" style="width: 200px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" 
                            name="tgl_masuk" readonly="readonly" value="<?php echo "" . date("Y/m/d") . ""; ?>"></td>
                          </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;width:220px; font-family : times new roman ; font-size : 25px ;"><h sty>Harga</h></td>
                            <td align="center" style="width:50px;">:</td>
                            <td align="left"><input type="text" style="width: 400px;  height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="harga" 
                            value="<?php echo $d['harga'] ?>" ></td>
                          </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;font-family : times new roman ; font-size : 25px ;">Jumlah Barang</td>
                            <td>:</td>
                            <td align="left"><input type="number" style="width: 200px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" name="jumlah" required></td>
                          </tr> 

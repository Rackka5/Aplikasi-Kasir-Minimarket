...
<div class="col-sm-5 mb-4">
    ...
    <div class="card text-center" 
                ...
                foreach ($data as $d){
                ?>
								<form action="../proses/proses_barang.php?aksi=edit" method="POST">
                        ...
                        <input type="hidden" name="id_barang" value="<?php echo $d['id_barang'] ?>">
                            ...
                            name="nama_barang" value="<?php echo $d['nama_barang'] ?>" ></td>
                          </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;font-family : times new roman ; font-size : 25px ;"><h>Kode Barang</h></td>
                            <td>:</td>
                            <td align="left"><input type="text" style="width: 400px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" 
                            name="kode_barang" value="<?php echo $d['kode_barang'] ?>"></td>
                            </tr>
                          <tr>
                            <td align="left" style="padding-left: 50px;font-family : times new roman ; font-size : 25px ;">Harga</td>
                            <td>:</td>
                            <td align="left"><input type="number" style="width: 200px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" 
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td align="left"><input type="number" style="width: 200px; height : 40px;border : 3px solid #5B9BD5; border-radius: 10px;" 
                            name="stok"  value="<?php echo $d['stok'] ?>" readonly="readonly"></td>
                          </tr> 

...
//Fungsi untuk mengubah nilai mnejadi format rupiah
...
?>
    ...
    <td><?php echo rupiah ($d['kembalian']) ?></td>
    <td>
        <?php
        if ($d['id_member'] == 0){
            echo '-';
...
if ($page > 1){
?>
 <button style="width: 50px;"><a style="font-size: 20px;color: blue;  text-decoration: none;" href="data_pemesanan copy.php?page=<?php echo $page - 1 ?>"><<</a></button>
<?php
}
?>
...
?>
 ...
 <button style="width: 50px;"><a style="font-size: 20px;color: blue; text-decoration: none;" href="data_pemesanan copy.php?page=<?php echo $i?>"><?php echo $i; ?></a></button>

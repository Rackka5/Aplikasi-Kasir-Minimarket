...
<div class="container-fluid" style="padding-top : 3rem;">
  <div class="row">
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 250px; height: 95vh; background-color :  #333A73;; ">
							...
							<div class="card-body text-black">
								<!-- Deskripsi -->
								 <table style="border: #2940D3;" class="table table-bordered table-striped table-hover">
                                    ...
                                    ?>
                                    <tr >
                                        <form action="kasir1.php?id_pemesanan=<?php echo $d['id_pemesanan']; ?>" method="POST">
                                        <td><?php echo $no++; ?></td>
                ...
                <input type="hidden" name="tgl_pemesanan" readonly="readonly" value="<?php echo "" . date("Y/m/d") . ""; ?>">
                  ...
                  <table style="width: 500px;margin-bottom : 20px;">
                    ...
                    <td align="right" colspan="3">
                        <a href="kasir1.php?&aksi=hapus"><button type="button" class="btn btn-warning">Hapus Semua</button> </a>
                        </td>
                    </tr>
                    <?php
                    if (isset($_GET['aksi'])){
                  ...
                  <table>
                    ...
                    <tr>
                        <td>Bayar</td>  
                        <td>:</td>
                        <td style="padding-left: 15px;"><input type="number" id="jumlahBayar" 
                        name="bayar" oninput="hitungKembalian()"></td>
                    </tr>
                    <tr>
                        <td>Kembalian</td>
                        <td>:</td>
                    ...
                    <tr>
                      <td>Member</td>
                      <td>:</td>
                      <td style="padding-left: 15px;"><input type="number" value="0" name="id_member"></td>
                    </tr>

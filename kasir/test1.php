							...
							<div class="card-body text-black">
								<!-- Deskripsi -->
								 <table style="border: #2940D3;" class="table table-bordered table-striped table-hover">
                                    ...
                                    ?>
                                    <tr >
                                        <form action="test1.php?id_barang=<?php echo $d['id_barang']; ?>" method="POST">
                                        <td><?php echo $no++; ?></td>
        ...
        foreach($tampil as $d){
           ...
           ?>
                        <tr>
                            ...
                            <td><?php echo $d['harga'] ?><input type="hidden" name="harga" value="<?php echo $d['harga'] ?>"></td>
                            <td>
                            <?php
                            if ($d['stok'] > 1){
                            ?>
           ...
           <?php
                       ...
                       <tr>
                        ...
                        <a href="test1.php?&aksi=hapus"><button type="button" class="btn btn-warning">Hapus Semua</button> </a>
                        </td>
                        <td colspan="2">
